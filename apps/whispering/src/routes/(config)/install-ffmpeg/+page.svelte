				...
				<div class="flex items-center justify-between">
					<div class="space-y-3 flex-1 pr-8">
						...
						<Card.Description class="text-base leading-relaxed">
							FFmpeg converts audio to WAV format for local transcription and compresses files for efficient cloud API transmission.
						</Card.Description>
					</div>
					...
					<div class="space-y-6">
						...
						<ol class="space-y-6 text-sm text-muted-foreground">
							...
							<li class="flex gap-4">
								...
								<div class="space-y-2 flex-1">
									<p>Extract the ZIP file to <code
										class="bg-muted px-2 py-1 rounded text-xs font-mono"
										>C:\ffmpeg</code
									></p>
								</div>
							...
							<li class="flex gap-4">
								<span class="font-semibold text-foreground shrink-0">4.</span>
								<div class="space-y-6 flex-1">
									<p>Add <code class="bg-muted px-2 py-1 rounded text-xs font-mono"
										>C:\ffmpeg\bin</code
									...
									<div class="space-y-4 border-l-2 border-muted pl-6">
										...
										<ol class="space-y-3 text-sm text-muted-foreground">
											<li class="flex gap-3">
												...
												<span>Press <kbd class="bg-muted px-2 py-1 rounded font-mono text-xs"
													>Windows + X</kbd
												> and select "System"</span>
											</li>
											<li class="flex gap-3">
												<span class="shrink-0">b.</span>
												<span>Click "Advanced system settings" → "Environment Variables..."</span>
											</li>
											<li class="flex gap-3">
												<span class="shrink-0">c.</span>
												<span>Under "System variables", select "Path" → "Edit..." → "New"</span>
											</li>
											<li class="flex gap-3">
												<span class="shrink-0">d.</span>
												<span>Add: <code class="bg-muted px-2 py-1 rounded font-mono text-xs"
													>C:\ffmpeg\bin</code
												></span>
											</li>
											<li class="flex gap-3">
					...
					<div class="space-y-6 border-t pt-8">
						...
						<div class="space-y-5">
							<div class="p-5 border rounded-lg bg-muted/10 space-y-4">
								...
								<ul class="space-y-3 ml-4 list-disc text-sm text-muted-foreground">
									<li>
										Make sure you added <code class="bg-muted px-2 py-1 rounded font-mono text-xs"
											>C:\ffmpeg\bin</code
										>
										to PATH (not just
										<code class="bg-muted px-2 py-1 rounded font-mono text-xs">C:\ffmpeg</code>)
									</li>
									<li>Restart Whispering completely after adding to PATH</li>
									<li>
										Test in a new Command Prompt: <code
											class="bg-muted px-2 py-1 rounded font-mono text-xs">ffmpeg -version</code
										>
									</li>
								</ul>
							</div>
